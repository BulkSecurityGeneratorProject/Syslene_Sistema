...
import { SysleneEntityModule } from './entities/entity.module';
...
@NgModule({
  imports: [
    ...
    SysleneSharedModule.forRoot(),
    SysleneCoreModule,
    SysleneHomeModule,
    SysleneAccountModule,
    // jhipster-needle-angular-add-module JHipster will add new module here
    SysleneEntityModule,
    SysleneAppRoutingModule
  ],
